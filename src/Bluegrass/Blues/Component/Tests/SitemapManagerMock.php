...
class SitemapManagerMock extends AbstractSitemapManager
{
    protected function buildSitemap()
    {
        ...
        $node_1 = $sitemap->getRoot()->addChild(new Node("node_1", new RouteBasedLocation("node_1")));
        $node_2 = $sitemap->getRoot()->addChild(new DynamicLabelNodeMock(new Node("node_2", new RouteBasedLocation("node_2", array("param_1" => "param_1_value")))));
        $node_2_1 = $node_2->addChild(new Node("node_2_1", new RouteBasedLocation("node_2_1", array("param_1" => "param_1_value"))));
