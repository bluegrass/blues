...
namespace Bluegrass\Blues\Component\Tests\Widget\Breadcrumb\Views;
...
use Bluegrass\Blues\Component\Widget\Breadcrumb\Views\BreadcrumbViewModelBuilder;
...
class BreadcrumbViewModelBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function createWidget()
    {
        ...
        $url = $this->getMockBuilder('Bluegrass\Blues\Component\Model\Web\Location\RouteBasedLocation')
    ...
    {
        $result = $this->getMock('Bluegrass\Blues\Component\Model\Web\Location\UrlGeneratorInterface');
