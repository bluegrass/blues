 ...
 * @author ldelia
 */
class KendoGridStringColumnViewModelBuilder implements GridWidgetColumnViewModelBuilderInterface
{        
    /**
    ...
    function build(GridWidgetColumnInterface $column)
    {
        ...
        $viewModel->set('template', '@BluegrassBluesWidget/kendo/grid/column/string_column/column.json.twig');
